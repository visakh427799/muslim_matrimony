...
exports.ShowProfile = async function (req, res, next) {
  if (res.user) {
    ...
    const{age,username,profile_pic,profile_pic_status,country,state,place,district,financial_status,home_type,father_details,mother_details,no_sisters,no_brothers,address }=data3;
